...
//               decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_ aurora_64b66b_tx_0_stub.v
...
(* X_CORE_INFO = "aurora_64b66b_v12_0_3, Coregen v14.3_ip3, Number of lanes = 4, Line rate is double25.0Gbps, Reference Clock is double156.25MHz, Interface is Streaming, Flow Control is None and is operating in DUPLEX configuration" *)
module decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix(s_axi_tx_tdata, s_axi_tx_tvalid, 
  s_axi_tx_tready, txp, txn, gt_refclk1_p, gt_refclk1_n, gt_refclk1_out, tx_hard_err, 
  tx_soft_err, tx_channel_up, tx_lane_up, user_clk_out, mmcm_not_locked_out, reset2fg, 
  sync_clk_out, reset_pb, gt_rxcdrovrden_in, power_down, pma_init, gt_pll_lock, s_axi_awaddr, 
