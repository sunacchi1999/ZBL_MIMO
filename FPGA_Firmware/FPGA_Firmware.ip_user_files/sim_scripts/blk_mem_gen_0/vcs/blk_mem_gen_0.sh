...
#
# Generated by Vivado on Mon Apr 21 11:51:59 +0800 2025
...
# Design libraries
design_libs=(xilinx_vip blk_mem_gen_v8_4_4 xil_defaultlib)
...
compile()
{
  ...
  vlogan -work blk_mem_gen_v8_4_4 $vlogan_opts +v2k +incdir+"C:/Xilinx/Vivado/2020.2/data/xilinx_vip/include" \
  ...
  vlogan -work xil_defaultlib $vlogan_opts +v2k +incdir+"C:/Xilinx/Vivado/2020.2/data/xilinx_vip/include" \
    "$ref_dir/../../../../FPGA_Firmware.gen/sources_1/ip/blk_mem_gen_0/sim/blk_mem_gen_0.v" \
  2>&1 | tee -a vlogan.log
