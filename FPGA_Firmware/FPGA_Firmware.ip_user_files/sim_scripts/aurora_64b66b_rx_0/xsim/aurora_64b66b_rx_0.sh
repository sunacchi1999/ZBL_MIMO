...
elaborate()
{
  xelab --relax --debug typical --mt auto -L gtwizard_ultrascale_v1_7_9 -L xil_defaultlib -L fifo_generator_v13_2_5 -L xilinx_vip -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot aurora_64b66b_rx_0 xil_defaultlib.aurora_64b66b_rx_0 xil_defaultlib.glbl -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim aurora_64b66b_rx_0 -key {Behavioral:sim_1:Functional:aurora_64b66b_rx_0} -tclbatch cmd.tcl -log simulate.log
}
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb aurora_64b66b_rx_0.wdb xsim.dir)
